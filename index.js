...
program.on('--help', function(){
    console.log('  For more details please visit https://github.com/fsafaq/tray.io-cucumber-js#readme\n');
});
...
let Cli = new (require('cucumber').Cli)({argv: process.argv, cwd: process.cwd(), stdout: process.stdout});
